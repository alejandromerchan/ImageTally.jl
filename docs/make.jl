...
DocMeta.setdocmeta!(ImageTally, :DocTestSetup, :(using ImageTally); recursive = true)
...
makedocs(;
    ...
    format = Documenter.HTML(; canonical = "https://H. Alejandro Merchan.github.io/ImageTally.jl"),
    pages = list_pages(),
)
